...
- (IBAction)showAssetTypePicker:(id)sender {
    ...
    HHAAssetTypeViewController *avc = [[HHAAssetTypeViewController alloc] init];
    avc.item = self.item;
    
    self.navController = [[UINavigationController alloc] initWithRootViewController:avc];
    ...
    self.navController.navigationItem.rightBarButtonItem = doneItem;
...
- (void)add:(HHAAssetType *)assetType {
